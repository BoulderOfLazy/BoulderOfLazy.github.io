        ...
        function updateUI(lang) {
            ...
            document.getElementById('download-btn').innerText = t.downloadButton;
            ...
            document.getElementById('modal-save').innerText = t.modalSave;
            ...
            document.getElementById('info-modal-close').innerText = t.infoClose;

            document.getElementById('filename-input').placeholder = t.filenamePlaceholder;
            document.getElementById('filename-save-btn').innerText = t.saveBtn;
...
`;
                ...
                t.phrases.forEach((phrase, index) => {
                    ...
                    const btnLabel = currentLang === 'ru' ? 'Пояснение' : 'Comment';
                    
                    const commentKey = currentLang + '_comment_' + index;
                    const hasComment = data.comments[commentKey] && data.comments[commentKey].trim() !== '';
                    const disabledState = hasComment ? '' : 'disabled style="opacity:0.5; cursor:default; background:#e0e0e0;"';
